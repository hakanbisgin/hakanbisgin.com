...
Bash scripting
        ...
        <x-custom.box icon='<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="#000000" height="45px">
                <g stroke-width="0"></g>
                <g stroke-linecap="round" stroke-linejoin="round"></g>
                <g>
                    <g fill="none" fill-rule="evenodd">
                        <circle cx="16" cy="16" fill="#" r="16"></circle>
                        <path
                            ...
                            fill="#FF2D20" fill-rule="nonzero"></path>
                    </g>
                </g>
            </svg>'>
...
Testing software for acceptance.
        ...
        <x-custom.box icon='<svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                ...
                                <path fill="#FF2D20" d="m3.55 1.893 8 4.048a1.008 1.008 0 0 0 .9 0l8-4.048a1 1 0 0 0-.9-1.785l-7.322 3.706a.506.506 0 0 1-.452 0L4.454.108a1 1 0 0 0-.9 1.785H3.55Z"></path>
                            </svg>'>
            <h2 class="text-xl font-semibold text-black dark:text-white">Education and Training</h2>
            <p class="mt-4 text-sm/relaxed">
                <b>
...
MASTER CLASS : TCP/IP EXPERT MECHANICS
            ...
            <p class="mt-4 text-sm/relaxed">
                <b>
                    ...
                    Canakkale Onsekiz Mart University Canakkale, Turkey <br>
                    Bachelor's degree
                </b>
            </p>
            <pre style="text-wrap: wrap" class="text-xs border-b-2">
...
TDD (JUNIT)
        ...
        <x-custom.box style="grid-column: 1 / -1;"
                    ...
                    <g fill="#FF2D20">
                      ...
                      content='<h2 class="text-xl font-semibold text-black dark:text-white">Online links</h2>
                <div class="inline-flex mt-4" style="column-gap: .75rem; row-gap: .25rem; flex-wrap: wrap;">
                    <a href="https://www.linkedin.com/in/hakan-bi%C5%9Fgin-184368138/" class="w-full">
                        <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                             fill="currentColor">
                            <path
                                d="M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h3zM6.5 8.25A1.75 1.75 0 118.3 6.5a1.78 1.78 0 01-1.8 1.75zM19 19h-3v-4.74c0-1.42-.6-1.93-1.38-1.93A1.74 1.74 0 0013 14.19a.66.66 0 000 .14V19h-3v-9h2.9v1.3a3.11 3.11 0 012.7-1.4c1.55 0 3.36.86 3.36 3.66z"></path>
                        </svg>
                        linkedin.com/in/hakan-bi%C5%9Fgin-184368138
                    </a>
                    <a href="https://github.com/hakanbisgin" class="w-full">
                        <svg class="size-5 sm:size-6" aria-hidden="true" viewBox="0 0 24 24" data-view-component="true"
                             fill="currentColor">
                            <path
                        ...
                        github.com/hakanbisgin
                    </a>
                    <a href="https://twitter.com/HakanBSGN1" class="w-full">
                        <svg class="size-5 sm:size-6" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
                            <g>
                                <path
                                    d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path>
                            </g>
                        </svg>
                        twitter.com/HakanBSGN1
                    </a>
                    <a href="https://www.facebook.com/hakan256/" class="w-full">
                        <svg class="size-5 sm:size-6" viewBox="0 0 36 36" fill="currentColor">
                            <path
                                d="M20.181 35.87C29.094 34.791 36 27.202 36 18c0-9.941-8.059-18-18-18S0 8.059 0 18c0 8.442 5.811 15.526 13.652 17.471L14 34h5.5l.681 1.87Z"></path>
                            <path class="xe3v8dz"
                        ...
                        facebook.com/hakan256
                    </a>
                    <a href="https://www.instagram.com/hakan256/" class="w-full">
                        <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                             viewBox="0 0 16 16">
                            <path
                        ...
                        instagram.com/hakan256
                    </a>
                    <a href="https://www.youtube.com/@hakanbisgin" class="w-full">
                        ...
                        youtube.com/@hakanbisgin
                    </a>
                    <a href="mailto:hakanbisgin95@gmail.com?subject=Merhaba Hakan Bey @hakanbisgin.com&amp;body=Merhaba Hakan Bey, size hakanbisgin.com üzerinden ulaşıyorum." class="w-full">
                        <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                             viewBox="0 0 16 16">
                            <path
                                d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"/>
                        </svg>
                        hakanbisgin95@gmail.com
                    </a>
                </div>'>
        </x-custom.box>
    </div>
