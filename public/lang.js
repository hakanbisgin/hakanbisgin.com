...
const translations = {
    tr: {
        ...
        'resume.projects.project5.tech': 'Teknolojiler: JavaScript, WebSocket, Node.js, Real-time APIs',
        'resume.projects.project5.desc': 'Birden fazla canlı yayın akışını eşzamanlı izlemek için geliştirilen gerçek zamanlı monitoring dashboard. WebSocket teknolojisi ile anlık akış sağlığı takibi, otomatik uyarı sistemi ve kapsamlı log kayıt özellikleri içerir.',
        
        'resume.projects.project6.title': 'Hızlı Logo Tespit Sistemi',
        'resume.projects.project6.period': '2024',
        'resume.projects.project6.tech': 'Teknolojiler: Python, OpenCV, Deep Learning, CUDA',
        'resume.projects.project6.desc': 'Yayın izleme ve RTÜK uyumluluğu için geliştirilen gerçek zamanlı logo tespit ve tanıma sistemi. Bilgisayarlı görü ve derin öğrenme teknikleri kullanarak video akışlarında logoları yüksek doğruluk ve minimum gecikme ile tespit eder.',
        
        'resume.projects.project7.title': 'Otomatik Trading Botu',
        'resume.projects.project7.period': '2024',
        'resume.projects.project7.tech': 'Teknolojiler: Python, Trading APIs, Data Analysis, Machine Learning',
        'resume.projects.project7.desc': 'Çoklu strateji, risk yönetimi ve gerçek zamanlı piyasa analizi içeren gelişmiş kripto para trading botu. Frekans tabanlı havuz yatırım algoritmaları ve otomatik işlem gerçekleştirme özellikleri ile optimize edilmiş trading kararları sağlar.',
        
        'resume.projects.project8.title': 'Video Analiz ve Timecode Aracı',
        'resume.projects.project8.period': '2024',
        'resume.projects.project8.tech': 'Teknolojiler: Python, FFmpeg, Video Processing, Metadata Analysis',
        'resume.projects.project8.desc': 'Yayın operasyonları için geliştirilen kapsamlı video analiz aracı. Timecode çıkarma, kare analizi, kalite değerlendirmesi ve otomatik raporlama özellikleri ile broadcast workflow\'unu optimize eder.',
        
        'resume.projects.project9.title': 'CNBC-e Log İşleme Sistemi',
        'resume.projects.project9.period': '2024',
        'resume.projects.project9.tech': 'Teknolojiler: Python, Data Processing, Automation, Report Generation',
        'resume.projects.project9.desc': 'Yayın operasyonları için geliştirilen otomatik log işleme ve analiz sistemi. Büyük hacimli log verilerini işler, detaylı raporlar oluşturur ve operasyonel verimlilik için içgörüler sağlar.',
        
        'resume.projects.project10.title': 'Video Üzerinde Template Matching (CUDA)',
        'resume.projects.project10.period': '2024',
        'resume.projects.project10.tech': 'Teknolojiler: Python, CUDA, OpenCV, GPU Computing, Parallel Processing',
        'resume.projects.project10.desc': 'GPU hızlandırma için CUDA kullanan yüksek performanslı video template matching sistemi. Video akışlarında gerçek zamanlı desen tespiti yapabilir ve paralel işleme ile optimize edilmiş performans sağlar.',
        
        'resume.projects.project11.title': 'Sistem Yardımcısı ve Otomasyon Paketi',
        'resume.projects.project11.period': '2024',
        'resume.projects.project11.tech': 'Teknolojiler: Python, PowerShell, Bash, System APIs, Task Scheduling',
        'resume.projects.project11.desc': 'Sistem yönetimi ve otomasyon araçları koleksiyonu. Dosya yönetimi, sistem izleme, yedekleme otomasyonu ve günlük operasyonlar için çeşitli yardımcı scriptler içerir. Rutin görevleri otomatikleştirerek operasyonel verimliliği artırır.',
    ...
    en: {
        ...
        'resume.projects.project5.period': '2024',
        'resume.projects.project5.tech': 'Technologies: JavaScript, WebSocket, Node.js, Real-time APIs',
        'resume.projects.project5.desc': 'Real-time monitoring dashboard for tracking multiple live broadcast streams simultaneously. Features WebSocket technology for instant stream health monitoring, automated alert system, and comprehensive logging capabilities.',
        
        'resume.projects.project6.title': 'Fast Logo Detection System',
        'resume.projects.project6.period': '2024',
        'resume.projects.project6.tech': 'Technologies: Python, OpenCV, Deep Learning, CUDA',
        'resume.projects.project6.desc': 'Real-time logo detection and recognition system developed for broadcast monitoring and regulatory compliance. Detects and tracks logos in video streams with high accuracy and minimal latency using computer vision and deep learning techniques.',
        
        'resume.projects.project7.title': 'Automated Trading Bot',
        'resume.projects.project7.period': '2024',
        'resume.projects.project7.tech': 'Technologies: Python, Trading APIs, Data Analysis, Machine Learning',
        'resume.projects.project7.desc': 'Sophisticated cryptocurrency trading bot with multiple strategies, risk management, and real-time market analysis. Implements frequency-based pool investment algorithms and automated execution for optimized trading decisions.',
        
        'resume.projects.project8.title': 'Video Analyzer & Timecode Tool',
        'resume.projects.project8.period': '2024',
        'resume.projects.project8.tech': 'Technologies: Python, FFmpeg, Video Processing, Metadata Analysis',
        'resume.projects.project8.desc': 'Comprehensive video analysis tool developed for broadcast operations. Features timecode extraction, frame analysis, quality assessment, and automated reporting to optimize broadcast workflows.',
        
        'resume.projects.project9.title': 'CNBC-e Log Processing System',
        'resume.projects.project9.period': '2024',
        'resume.projects.project9.tech': 'Technologies: Python, Data Processing, Automation, Report Generation',
        'resume.projects.project9.desc': 'Automated log processing and analysis system developed for broadcast operations. Processes large volumes of log data, generates detailed reports, and provides insights for operational efficiency.',
        
        'resume.projects.project10.title': 'Template Matching on Video (CUDA)',
        'resume.projects.project10.period': '2024',
        'resume.projects.project10.tech': 'Technologies: Python, CUDA, OpenCV, GPU Computing, Parallel Processing',
        'resume.projects.project10.desc': 'High-performance video template matching system utilizing CUDA for GPU acceleration. Capable of real-time pattern detection in video streams with optimized performance through parallel processing.',
        
        'resume.projects.project11.title': 'System Helper & Automation Suite',
        'resume.projects.project11.period': '2024',
        'resume.projects.project11.tech': 'Technologies: Python, PowerShell, Bash, System APIs, Task Scheduling',
        'resume.projects.project11.desc': 'Comprehensive collection of system administration and automation tools. Includes file management, system monitoring, backup automation, and various utility scripts for daily operations. Enhances operational efficiency by automating routine tasks.',
